...
predictionsAndData = [scaledPredictions(abbreviated_set), means(abbreviated_set)'];
f1=figure();
...
hold on;
herrorbar(fliplr(means(abbreviated_set)), barpositions+0.15, zeros(1,8), CIs(abbreviated_set),'k.');
box off;
axis off;
